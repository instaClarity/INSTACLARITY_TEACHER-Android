...
import io.swagger.client.request.CustomRequest;
...
//    INSTANCE.addDefaultHeader("User-Agent", userAgent);
  ...
  */
  ...
  private ApiInvoker(Context context) {
    ...
    // presently maintaining a separate request queue for Multipart request.
    mMultipartQueue = Volley.newRequestQueue(context, new MultipartHurlStack());
  }
  ...
  public static boolean isContainerArray(String containerType, Class cls) throws ApiException
  {
    if("list".equalsIgnoreCase(containerType) || "array".equalsIgnoreCase(containerType)) {
      return true;
    }
  ...
  public String invokeAPI(String host, String path, String method, List<Pair> queryParams, String body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, String[] authNames) throws ApiException, InterruptedException, ExecutionException, TimeoutException {
  ...
  public void invokeAPI(String host, String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, String[] authNames, Type responseContainerType,Response.Listener<Object> responseListener, Response.ErrorListener errorListener) throws ApiException {
    Request request = createRequest(host, path, method, queryParams, body, headerParams, formParams, contentType, authNames, responseContainerType,responseListener, errorListener);
    if (request != null) mRequestQueue.add(request);
  }

  public Request createRequest(String host, String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, String[] authNames, Type responseContainerType, Response.Listener<Object> responseListener, Response.ErrorListener errorListener) throws ApiException {
    StringBuilder b = new StringBuilder();
    b.append("?");
   ...
   /*  closed form-data parsing code as it is now done in getBody method of CustomRequest class.
    ...
    */
    ...
    int methodType=-2;   // type of method in Volley Request class. -2 is currently not being used by Request class.
    ...
    if ("GET".equals(method)) {
      ...
      //    request = new PostRequest(url, headers, contentType, formParamStr, stringRequest, errorListener);
      // } else if (body != null) {
      //       request = new PostRequest(url, headers, contentType, body, stringRequest, errorListener);
      // } else {
    ...
    request = new CustomRequest(methodType, url,headers,contentType, body, formParams, responseContainerType, responseListener, errorListener);
    if (request != null) {
