...
public final class Headers
{
    ...
    public List<String> values(String name)
    {
        ...
        return result != null ? Collections.unmodifiableList(result) : Collections
                .<String>emptyList();
    }
    ...
    {
        return other instanceof Headers && Arrays.equals(((Headers) other).namesAndValues,
                namesAndValues);
    }
    ...
    public static final class Builder
    {
        ...
        private void checkNameAndValue(String name, String value)
        {
            ...
            for (int i = 0, length = name.length(); i < length; i++)
            {
                ...
                if (c <= '\u001f' || c >= '\u007f')
                {
                    throw new IllegalArgumentException(Util.format("Unexpected char %#04x at %d "
                            + "in header name: %s", (int) c, i, name));
                }
            }
            if (value == null)
            {
            ...
            for (int i = 0, length = value.length(); i < length; i++)
            {
                ...
                {
                    throw new IllegalArgumentException(Util.format("Unexpected char %#04x at %d "
                            + "in %s value: %s", (int) c, i, name, value));
                }
            }
        }
