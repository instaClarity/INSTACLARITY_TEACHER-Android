 ...
 */
public class MultipartHurlStack implements com.android.volley.toolbox.HttpStack
{
    ...
    {
        return requestMethod != Method.HEAD && !(HttpStatus.SC_CONTINUE <= responseCode &&
                responseCode < HttpStatus.SC_OK) && responseCode != HttpStatus.SC_NO_CONTENT &&
            ...
            IOException, AuthFailureError
    {
        ...
        if (body != null)
        {
            ...
            if (request instanceof MultiPartRequest)
            {
                ...
                {
                    long contentLength = ((MultiPartRequest) request).getContentLength();
            ...
            ByteCountOutputStream outStream = new ByteCountOutputStream(connection
                    .getOutputStream(), body.length, progressListener);
        ...
        /*if (body != null)
        {
            ...
            ByteCountOutputStream out = new ByteCountOutputStream(connection.getOutputStream(), );
            out.write(body);
            out.close();
        }*/
    }
    ...
    private static class ByteCountOutputStream extends DataOutputStream
    {
        ...
        public ByteCountOutputStream(final OutputStream out, long length, final ProgressListener
                listener)
        {
            super(out);
            fileLength = length;
        ...
        public void write(int b) throws IOException
        {
            ...
            {
                transferred++;
                int newProgress = (int) (transferred * 100 / fileLength);
